export function decryptWithKeyWorker (encryptedData, recipientId, privateKeyBase64, privateKeyPassword) {
    ...
    try {
        let dataSource = new VirgilCryptoWorkerContext.VirgilStreamDataSource(new Uint8Array(encryptedData));
        ...
        let decryptedDataSink = new VirgilCryptoWorkerContext.VirgilStreamDataSink();
